...
const school = async () => {
    ...
    option1.focus();
    option1.placeholder = "Pray For A Relic? The Harvest just may grant it. Or do you instead wish insight on how existing Relic's work? (Or even how to find them?). You'll need to visit the Prayer section to see her answers, of course, but this is a great place to fire off questions.";
